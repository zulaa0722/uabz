...
<div id="modalFoodFactoryNew" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
      {{-- modal-lg --}}
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0">Хүнсний үйлдвэрийн судалгаа нэмэх</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
              <form id="frmFoodFactoryNew" action="" method="post">
                @csrf
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-6">
                      ...
                      <input class="form-control" type="text" name="activity" id="activity">
                    </div>
                    <div class="col-md-6">
                  ...
                  <div class="modal-footer">
                      <button type="submit" post-url="{{url('/survey/food/factory/new')}}" id="btnFoodFactoryAdd" class="btn btn-primary">Хадгалах</button>
